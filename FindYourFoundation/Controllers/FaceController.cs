            ...
            if (HttpRequest.Files.Count > 0)
            {
                foreach (string name in HttpRequest.Files.Keys)
                {
                    ...
                    else
                    {
                        ...
                        skinColor.Add("#fce0d5", 11);                        
                        skinColor.Add("#fcdbbd", 24);                        
                        skinColor.Add("#fddbb8", 24);                        
                        skinColor.Add("#ebd4ae", 26);                        
                        skinColor.Add("#e6c7a1", 18);                        
                        skinColor.Add("#e3bf91", 15);                        
                        skinColor.Add("#efd0bb", 16);                        
                        skinColor.Add("#dbb88c", 15);                        
                        skinColor.Add("#DABA93", 25);                        
                        skinColor.Add("#DCB8A5", 19);                        
                        skinColor.Add("#edd2a4", 18);                        
                        skinColor.Add("#F8D0B3", 27);                        
                        skinColor.Add("#edd4b7", 16);                        
                        skinColor.Add("#f2cdb6", 16);                        
                        skinColor.Add("#f0c999", 28);                        
                        skinColor.Add("#ffc0a3", 28);                        
                        skinColor.Add("#e0b7a6", 5);                        
                        skinColor.Add("#DFC0AB", 19);                        
                        skinColor.Add("#e6ba9a", 25);                        
                        skinColor.Add("#f2c7a5", 27);                        
